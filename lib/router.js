...
//   template: 'reviewFlashcards',
//   layoutTemplate: 'flashcardLayout',
//   yieldTemplates: {
//     'reviewFlashcardsSidebar': {to: 'sidebar'},
//     // 'listSidebar': {to: 'sidebar-right'}
//     },
// });

Router.route('/review/quiz/:_id',{
  name: 'reviewQuizFlashcards',
  template: 'reviewFlashcards',
  layoutTemplate: 'flashcardLayout',
  yieldTemplates: {
    'reviewFlashcardsSidebar': {to: 'sidebar'},
...
Router.route('/review/article/:_id',{
  name: 'reviewArticleFlashcards',
  template: 'reviewFlashcards',
  layoutTemplate: 'flashcardLayout',
  yieldTemplates: {
    'reviewFlashcardsSidebar': {to: 'sidebar'},
...
Router.route('/review/topic/:_id',{
  name: 'reviewTopicFlashcards',
  template: 'reviewFlashcards',
  layoutTemplate: 'flashcardLayout',
  yieldTemplates: {
    'reviewFlashcardsSidebar': {to: 'sidebar'}
